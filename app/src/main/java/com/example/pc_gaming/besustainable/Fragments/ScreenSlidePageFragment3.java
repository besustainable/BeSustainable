...
public class ScreenSlidePageFragment3 extends Fragment {
    ...
    public static int resultAnswer3 = 50;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.fragment_screen_slide_page_3, container, false);
        ...
        iv_Principle.setImageResource(R.drawable.principle3_icon);
        ...
        indicatorSeekBar.setOnSeekChangeListener(new IndicatorSeekBar.OnSeekBarChangeListener() {
            ...
            public void onStartTrackingTouch(IndicatorSeekBar seekBar, int thumbPosOnTick) {
                ...
                if(seekBar.getProgress() < 50)
                    seekBar.getBuilder().setIndicatorCustomTopContentLayout(R.layout.custom_seekbar_text_3_1).apply();
                else
                    seekBar.getBuilder().setIndicatorCustomTopContentLayout(R.layout.custom_seekbar_text_3_2).apply();
            ...
            public void onStopTrackingTouch(IndicatorSeekBar seekBar) {
                ...
                resultAnswer3 = seekBar.getProgress();
