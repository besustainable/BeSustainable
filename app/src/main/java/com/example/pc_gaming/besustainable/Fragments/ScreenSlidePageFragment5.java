...
public class ScreenSlidePageFragment5 extends Fragment {
    ...
    public static int resultAnswer5 = 50;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.fragment_screen_slide_page_5, container, false);
        ...
        iv_Principle.setImageResource(R.drawable.principle5_icon);
        ...
        indicatorSeekBar.setOnSeekChangeListener(new IndicatorSeekBar.OnSeekBarChangeListener() {
            ...
            public void onStartTrackingTouch(IndicatorSeekBar seekBar, int thumbPosOnTick) {
                ...
                if(seekBar.getProgress() < 50)
                    seekBar.getBuilder().setIndicatorCustomTopContentLayout(R.layout.custom_seekbar_text_5_1).apply();
                else
                    seekBar.getBuilder().setIndicatorCustomTopContentLayout(R.layout.custom_seekbar_text_5_2).apply();
            ...
            public void onStopTrackingTouch(IndicatorSeekBar seekBar) {
                ...
                resultAnswer5 = seekBar.getProgress();
