...
public class ScreenSlidePageFragment7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.fragment_screen_slide_page_7, container, false);
        ...
        iv_Principle.setImageResource(R.drawable.principle7_icon);
        ...
        indicatorSeekBar.setOnSeekChangeListener(new IndicatorSeekBar.OnSeekBarChangeListener() {
            ...
            public void onStartTrackingTouch(IndicatorSeekBar seekBar, int thumbPosOnTick) {
                ...
                if(seekBar.getProgress() < 50)
                    seekBar.getBuilder().setIndicatorCustomTopContentLayout(R.layout.custom_seekbar_text_7_1).apply();
                else
                    seekBar.getBuilder().setIndicatorCustomTopContentLayout(R.layout.custom_seekbar_text_7_2).apply();
            ...
            public void onStopTrackingTouch(IndicatorSeekBar seekBar) {
                ...
                resultAnswer7 = seekBar.getProgress();
